...
class HTTPHandler(BaseHTTPRequestHandler):
    def do_POST(self):
        ...
        # payload = {key: value for key, value in [el.split('=') for el in
        #                                          body.split('&')]}
        #
        # with open(BASE_DIR.joinpath('storage/data.json'), 'w',
...
def save_data(data):
    ...
    try:
        ...
        logging.error(f"Field write data {body} is mistake {err}")
